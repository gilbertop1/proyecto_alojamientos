...
import tecnm.toluca.pruebas.DetalleServReserva;
 ...
 */
@Stateless
@Path("tecnm.toluca.pruebas.detalleservreserva")
public class DetalleServReservaFacadeREST extends AbstractFacade<DetalleServReserva> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, DetalleServReserva entity) {
        super.edit(entity);
    }
    ...
    public DetalleServReserva find(@PathParam("id") Integer id) {
