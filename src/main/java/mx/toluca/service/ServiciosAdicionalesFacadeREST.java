...
import tecnm.toluca.pruebas.ServiciosAdicionales;
 ...
 */
@Stateless
@Path("tecnm.toluca.pruebas.serviciosadicionales")
public class ServiciosAdicionalesFacadeREST extends AbstractFacade<ServiciosAdicionales> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, ServiciosAdicionales entity) {
        super.edit(entity);
    }
    ...
    public ServiciosAdicionales find(@PathParam("id") Integer id) {
