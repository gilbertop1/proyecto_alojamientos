...
import com.tolback.xmockups.Estados;
 ...
 */
@Stateless
@Path("com.tolback.xmockups.estados")
public class EstadosFacadeREST extends AbstractFacade<Estados> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Short id, Estados entity) {
        super.edit(entity);
    }
    ...
    public Estados find(@PathParam("id") Short id) {
