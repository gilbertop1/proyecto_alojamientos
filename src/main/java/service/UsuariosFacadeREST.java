...
public class UsuariosFacadeREST extends AbstractFacade<Usuarios> {
    ...
    public Usuarios findUserByCorreoAndContrasena(String correo, String contrasena) {
        TypedQuery<Usuarios> query = em.createNamedQuery("Usuarios.findByCorreoAndContrasena", Usuarios.class);
